# Contributing to RDS-JS

We would love for you to contribute to RDS-JS and help make it even better than it is
...
Help us keep RDS-JS open and inclusive. Please read and follow our [Code of Conduct][coc].
...
1. Search [GitHub](https://github.com/mtna/rds-js/pulls) for an open or closed PR
   that relates to your submission. You don't want to duplicate effort.
1. Be sure that an issue describes the problem you're fixing, or documents the design for the feature you'd like to add.
   Discussing the design up front helps to ensure that we're ready to accept your work.
1. Fork the mtna/rds-js repo.
...
1. In GitHub, send a pull request to `rds-js:master`.
...
[github]: https://github.com/mtna/rds-js
